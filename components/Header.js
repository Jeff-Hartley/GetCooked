...
const Header = () => {
    return (
        <header style={{backgroundColor: " #999999"}}>
            <h1 style={{fontSize: "55px", color: "#111111", textAlign:"center", padding:"3px"}}>GetCooked</h1>
            <h2 style={{fontSize: "30px", color: "#111111", textAlign:"center"}}>The Interactive Recipe Book</h2>
            ...
            <div>
                <ul style={{display:"grid", justifyContent:"center", color: "#111111", padding: "4px", textDecoration:"underline"}}>
                    ...
                    <li style={{fontSize:"14px", listStyle:"none", textAlign:"center"}}><Link href="/favourites">Your Favourites</Link></li>
                </ul>
            </div>
        </header>
    );
