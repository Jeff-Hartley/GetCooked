...
const ContactForm = () => {
    ...
    return (
        <div style={{backgroundColor: "#BABABA", width: "30%", marginTop: "30px", marginLeft: "30px", padding: "7px"}}>
            ...
            <form onSubmit={submit}>
                ...
                <div>
                    ...
                    <textarea id="msg" ref={msgRef} style={{margin: "5px", backgroundColor: "white", color: "black", width: "400px", height: "120px"}}/>
                    {msgError && <p style={{color: "#ac4128", margin: "5px"}}>{msgError}</p>}
                </div>


                <button id="formBtn" type="submit" style={{backgroundColor: "black", margin: "5px"}}>Submit The Form</button>
            </form>
        </div>
    );
};
